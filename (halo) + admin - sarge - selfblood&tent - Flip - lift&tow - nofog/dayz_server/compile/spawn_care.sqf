...
if (isDedicated) then {
	...
	switch (_vehicleloottype) do {
		case "Military": {
			...
			_itemChance = [0.05, 0.05, 0.01, 0.02, 0.2, 0.15, 0.01, 0.08, 0.05, 0.05, 0.01, 0.1, 0.01, 0.02, 0.01, 0.05, 0.08, 0.1, 0.04, 0.02, 0.01, 0.06, 0.1, 0.1, 0.01, 0.05, 0.06, 0.04, 0.7, 0.1, 1.0, 2.5, 0.05, 0.02];
		};
		case "Residential": {
