...
if (isDedicated) then {
	...
	_itemType =	[] + getArray (configFile >> "CfgBuildingLoot" >> "UH1YCrash" >> "itemType");
	_itemChance = [] + getArray (configFile >> "CfgBuildingLoot" >> "UH1YCrash" >> "itemChance");

	diag_log ("DEBUG: Spawning a UH1YWreck_DZ at " + str(_position));
