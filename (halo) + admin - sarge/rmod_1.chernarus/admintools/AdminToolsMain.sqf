...
if ((getPlayerUID player) in ["16478086"]) then { //all admins
	if ((getPlayerUID player) in ["XXXXX"]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["XXXXX"]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["16478086"]) then { // super admins
		adminmenu =
		[
			["",true],
